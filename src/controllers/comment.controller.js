...
export const deleteComment = async(req,res)=>{
  ...
  // Check ownership (or maybe video owner should also be able to delete? For now, just author)
  if(comment.author.toString() !== userId){
      // Optional: Allow video owner to delete comments too
      // const video = await Video.findById(comment.video);
      // if(video.owner.toString() !== userId) ...
    throw new ApiError(403,"You are not authorized to delete this comment","UNAUTHORIZED");
  }
